...
- `game_engine_prompt.md` 是 DeepSeek 优先通过 Raw URL 读取并执行的主提示词。
...
- 正式游玩前先测试 Raw URL 是否能读取 `TRIGGER_CANON_VERSION`，正式启动时优先让 DeepSeek 访问 `game_engine_prompt.md` 的 Raw URL。
